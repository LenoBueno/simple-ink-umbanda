-- MySQL Database Setup for Simple Ink Umbanda (Configuração Completa)
...
-- Note: Em ambiente de produção, você deve:
-- 1. Usar uma senha mais segura
-- 2. Considerar o uso de pool de conexões
-- 3. Armazenar credenciais em variáveis de ambiente, não no código
-- 4. Configurar procedimentos adequados de backup
-- 5. Configurar o MySQL para desempenho com base nas especificações do seu servidor
-- 6. Implementar hash adequado de senhas (a senha de admin acima está com hash bcrypt)